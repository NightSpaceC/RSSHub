...
module.exports = async (ctx) => {
    ...
    const wbiInfoQueryStr = utils.generateWbiInfoQueryStr(['w_rid', 'wts'], `mid=${uid}&pn=1&ps=25&index=1&order=pubdate&order_avoided=true&platform=web&web_location=0.0&${dmInfoQueryStr}`, wbiImg);
