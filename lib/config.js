...
const calculateValue = () => {
    ...
    value = {
        ...
        bilibili: {
            ...
            webglStr: envs.BILIBILI_WEBGL ?? 'WebGL 1.0 (OpenGL ES 2.0 Chromium)',
            webglVendorAndRenderer: envs.BILIBILI_WEBGL_VENDOR_AND_RENDERER ?? 'ANGLE (NVIDIA, NVIDIA GeForce RTX 4090 (0x00002684) Direct3D11 vs_5_0 ps_5_0, D3D11)Google Inc. (NVIDIA)',
        },
        bitbucket: {
